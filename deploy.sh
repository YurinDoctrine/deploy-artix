...
# System
pacman -Sy --noconfirm alsa-utils curl git lxdm-$MY_INIT kitty lz4 mesa nano openbox openssh pipewire procps psmisc wayland wget wireplumber xdg-utils xdg-user-dirs xorg xterm
