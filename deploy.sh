...
# System
pacman -Sy --noconfirm alsa-utils git iwd jemalloc kitty lxdm-$MY_INIT mesa openbox openssh pipewire pipewire-alsa wayland wget wireplumber xdg-utils xdg-user-dirs xorg xterm
