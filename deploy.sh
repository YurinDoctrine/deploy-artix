...
# System
pacman -Sy --noconfirm acpid-$MY_INIT alsa-utils git gtk-engines gtk-engine-murrine iwd jemalloc kitty lxdm-$MY_INIT mesa openbox pipewire pipewire-alsa thermald-$MY_INIT unzip wayland wget wireplumber xdg-utils xdg-user-dirs xorg xterm
