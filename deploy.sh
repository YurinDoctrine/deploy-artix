...
pacman -Sy --noconfirm acpid-$MY_INIT alsa-utils doas gtk-engines gtk-engine-murrine haveged-$MY_INIT kitty macchanger mesa openbox pipewire pipewire-alsa rsync thermald-$MY_INIT tor-$MY_INIT torsocks unzip vim wayland wget wireplumber wpa_supplicant xdg-desktop-portal-lxqt xdg-utils xdg-user-dirs xorg xorg-xinit xterm
