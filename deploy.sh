...
# System
pacman -Sy --noconfirm alsa-utils git gtk-engines gtk-engine-murrine iwd jemalloc kitty lxdm-$MY_INIT mesa mesa-utils openbox openssh pipewire pipewire-alsa wayland wget wireplumber xdg-utils xdg-user-dirs xorg xterm
